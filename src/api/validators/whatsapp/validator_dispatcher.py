"""Dispatcher de validação para mensagens WhatsApp/Meta.

Centraliza e despacha validadores específicos por tipo de mensagem.
Nota: arquivo renomeado de orchestrator.py para validator_dispatcher.py
para evitar confusão com orquestradores de use case (app/).
"""
...
from api.validators.whatsapp.media import (
...
from api.validators.whatsapp.text import (
    validate_text_message,
)
from app.constants.whatsapp import MessageCategory, MessageType
