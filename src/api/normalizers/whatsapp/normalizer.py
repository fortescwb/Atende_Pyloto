"""Normalizador de mensagens WhatsApp para modelo interno.

Responsabilidades:
- Converter estrutura intermediária para NormalizedWhatsAppMessage
...
from api.connectors.whatsapp.models import NormalizedWhatsAppMessage
