"""Modelos de protocolo (contratos) compartilhados entre app e api.

Responsabilidade:
- Definir contratos de dados que o core da aplicação consome/produz
- Evitar acoplamento app -> api

Sem PII e sem payload bruto.
"""
...
class NormalizedMessage(BaseModel):
    ...
    Campo message_type sempre reflete o tipo técnico do provedor:
